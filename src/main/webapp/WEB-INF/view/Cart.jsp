   ...
   <c:forEach items="${groupProductCart}" var="element">
    <tbody>
      <tr>
        <td data-th="Product">
          <div class="row">
            <div class="col-sm-2 hidden-xs"><img src="<c:url value="resources/img/"/>${element.product.getProductImageByIndex(0).image}" alt="..." class="img-responsive" /></div>
            <div class="col-sm-10">
        ...
        <c:url var="urlVar" value="/deleteProductFromCart" />
    ...
    <tfoot>
      ...
      <tr>
        ...
        <td><a href="<c:url value="/showCheckout" />" class="btn btn-success btn-block">Checkout <i class="fa fa-angle-right"></i></a></td>
